...
public class Warmup2 {
	...
	public static void main(String[] args) {
		// stringTimes
		String stringTimes = new Warmup2().stringTimes("Hi", 2);
		// frontTimes
		String frontTimes = new Warmup2().frontTimes("Chocolate", 2);
		// countXX
		int countXX  = new Warmup2().countXX("abcxx");
		// stringBits
		String stringBits = new Warmup2().stringBits("Hello");
		// stringBits
		String stringSplosion = new Warmup2().stringBits("Code");
		// last2
		int last2 = new Warmup2().last2("hixxhi");
		// arrayCount9
		int[] nums = {1, 2, 9};
		int arrayCount9 = new Warmup2().arrayCount9(nums);
		// stringX
		String stringX = new Warmup2().stringX("xxHxix");
		//altPairs
		String altPairs = new Warmup2().altPairs("Chocolate");
		// stringYak
		String stringYak = new Warmup2().stringYak("yak123ya");
		//array667
		int [] nums1 = {6,6,6,5,7};
		int array667 = new Warmup2().array667(nums1);
		// noTriples
		boolean noTriples = new Warmup2().noTriples(nums1);
	}
